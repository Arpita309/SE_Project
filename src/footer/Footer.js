    ...
    <div className="row">
        ...
        <div className="col-1-of2">
            <p className="footer__copyright">
                Copyright © <a href="#" className="footer__link">DAT</a> .You are 100% allowed to use this webpage for both personal and commercial use, but NOT to claim it as your own design. A credit to the original authors, 
                
                
                <a href="#" className="footer__link">( Arpita Tiwari</a>,
                <a href="#" className="footer__link"> Deeksha Sharma</a>,
                <a href="#" className="footer__link"> Tanya Bhandari</a>,
                <a href="#" className="footer__link"> Anand Aggarwal</a>)
