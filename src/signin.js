    ...
    return (
     <div className='loginRegister'>
        ...
        <div  className={`mobileSmall-logo ${this.state.nextStep?'hide':''}`}>
            <img  src={require('./annadanlogo.png')} width="26" height="35" alt="logo"></img>
        </div>
       
        <div  className="new-CloseButton" ><em  className="icon-cancel" onClick={event =>  window.location.href='/'}><i class="fas fa-times"></i></em></div>
        ...
        <div className='loginRegisterRight'>
            ...
            <div className='loginBox active'>
                ...
                <div  className="authHeading"><span  className="authHeading-main" style={{fontWeight:'bolder'}}>A small step towards</span>
                        <span  className="authHeading-sub">doing something good!</span></div>
                    ...
                    <form name='registerForm'>
                        <ul className='signupSteps activeStep'>
                            ...
                            <li>
                            <button  type="submit" className="submitButton" onClick={this.onSubmit}><span  className="icon-right"></span>Login</button>
                            </li>
